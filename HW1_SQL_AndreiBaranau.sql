...
--ВОПРОС: Почему здесь не отрабаывают [""]?
...
--select * from students where id like '53'; вариант 2, но именно здесь он не работает
-- ,а в https://www.w3schools.com/sql/trysql.asp?filename=trysql_select_columns вск OK
...
select * from students where id between 81 and 89;
...
select * from students where created_on='2020-10-03 00:00:00' or created_on='2021-05-19 00:00:00'
or created_on='2021-03-26 00:00:00'; 

--28. Вывести минимальный id 
select min(id) as minimal_id from students; 

29. Вывести максимальный.
--Неточная формулировка задачи, что значит "максимальный."
